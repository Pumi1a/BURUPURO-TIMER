...
## Points to note
Please report any errors to the developer via [Twitter](https://twitter.com/Pumi1a) or [github]((https://github.com/Pumi1a/BURUPURO-TIMER). I have tried to verify under various conditions, but as I am a beginner in Python, there may be bugs. I apologize for any inconvenience. The behavior of the /set_state command, in particular, might be strange. Bugs that I am aware of at this point are described towards the end.
