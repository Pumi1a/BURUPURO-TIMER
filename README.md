...
## Points to note
If there are any errors or strange behaviors, please notify the developer via [Twitter](https://twitter.com/Pumi1a). I believe I have tested under various conditions, but there might not have been enough debugging, and the behavior may be strange. I apologize. In particular, the behavior of the `/set_state` command may be odd.The bugs that are currently known are described towards the end.
