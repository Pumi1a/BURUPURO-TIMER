...
## 注意点
エラーや挙動がおかしかったりしたら、開発者の [Twitter](https://twitter.com/Pumi1a) までお知らせ下さい。様々な条件で検証をしたつもりですが、デバッグが足りておらずおかしな挙動を示すかもしれません。申し訳ありません。特に `/set_state` コマンドあたりの挙動がおかしいかもしれません。現時点で把握しているバグについては最後の方で記載しています。
